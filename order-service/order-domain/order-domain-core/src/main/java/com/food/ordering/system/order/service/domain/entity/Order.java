...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void pay() {
        if (orderStatus != OrderStatus.PENDING) {
            throw new OrderDomainException("Order status is not in correct status for pay operation");
        }
    ...
    public void approve() {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order status is not in correct status for approve operation");
        }
    ...
    public void initCancel(List<String> failureMessages) {
        if (orderStatus != OrderStatus.PAID) {
            throw new OrderDomainException("Order status is not in correct status for initCancel operation");
        }
    ...
    public void cancel(List<String> failureMessages) {
        if (!(orderStatus == OrderStatus.CANCELLING || orderStatus == OrderStatus.PENDING)) {
            throw new OrderDomainException("Order status is not in correct status for cancel operation");
        }
